...
export default class Login extends Vue{
  ...
  userName = '';
  password = '';    
  loginModule: LoginModule = new LoginModule(getModule(LoginModule));
  user: IUser = {UserName:this.userName, Password : this.password};

  login(){
    this.user.UserName = this.userName;
    this.user.Password = this.password;
    console.log(this.user.UserName+ " "+ this.user.Password);       
    const token =  this.loginModule.login(this.user)
    console.log(token);
